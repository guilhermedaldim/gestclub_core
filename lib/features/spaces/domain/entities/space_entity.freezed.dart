...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? id,  String name,  SpaceType type,  String? description,  String? image, @JsonKey(name: 'schedule_start')  String? scheduleStart, @JsonKey(name: 'schedule_end')  String? scheduleEnd, @JsonKey(name: 'allowed_categories')  List<String>? allowedCategories,  List<Map<String, String>>? periods)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SpaceEntity() when $default != null:
return $default(_that.id,_that.name,_that.type,_that.description,_that.image,_that.scheduleStart,_that.scheduleEnd,_that.allowedCategories,_that.periods);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? id,  String name,  SpaceType type,  String? description,  String? image, @JsonKey(name: 'schedule_start')  String? scheduleStart, @JsonKey(name: 'schedule_end')  String? scheduleEnd, @JsonKey(name: 'allowed_categories')  List<String>? allowedCategories,  List<Map<String, String>>? periods)  $default,) {final _that = this;
switch (_that) {
case _SpaceEntity():
return $default(_that.id,_that.name,_that.type,_that.description,_that.image,_that.scheduleStart,_that.scheduleEnd,_that.allowedCategories,_that.periods);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? id,  String name,  SpaceType type,  String? description,  String? image, @JsonKey(name: 'schedule_start')  String? scheduleStart, @JsonKey(name: 'schedule_end')  String? scheduleEnd, @JsonKey(name: 'allowed_categories')  List<String>? allowedCategories,  List<Map<String, String>>? periods)?  $default,) {final _that = this;
switch (_that) {
case _SpaceEntity() when $default != null:
return $default(_that.id,_that.name,_that.type,_that.description,_that.image,_that.scheduleStart,_that.scheduleEnd,_that.allowedCategories,_that.periods);case _:
  return null;
