...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  int points,  int rank,  List<PlayerEntity> players)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TeamEntity() when $default != null:
return $default(_that.id,_that.name,_that.points,_that.rank,_that.players);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  int points,  int rank,  List<PlayerEntity> players)  $default,) {final _that = this;
switch (_that) {
case _TeamEntity():
return $default(_that.id,_that.name,_that.points,_that.rank,_that.players);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  int points,  int rank,  List<PlayerEntity> players)?  $default,) {final _that = this;
switch (_that) {
case _TeamEntity() when $default != null:
return $default(_that.id,_that.name,_that.points,_that.rank,_that.players);case _:
  return null;
